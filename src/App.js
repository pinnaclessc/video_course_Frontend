...
import CourseCreate from "./src-d/components/instructor/CourseCreate"
import Footer from "./Footer02.js/Footer";
import AdminPage from "./Admin/AdminPage";
import CourseContent from "./Admin/Pages/CourseContent";
import LearningPage from './MyLearning/MyLearning';
    ...
    <div>
      ...
      <Header/>
        <Routes>
          ...
          <Routes>
          <Route path="/MyLearningMain" element={<MyLearningMain />}/>
