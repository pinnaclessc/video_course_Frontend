...
//     let result=await fetch("http://localhost:8000/add-course",{
//       method:"post",
//       body:JSON.stringify({ courseTitle, courseDetails, rating, teacherName,price,category,SEOCode}),
...
// const addCourseHandler = async (e) => {
//   e.preventDefault();
//   const videoData = { courseTitle, courseDetails, rating, teacherName,price,category,SEOCode};
// try {
//     const response = await fetch("http://localhost:8000/add-course",{
//       method: "POST",
//       headers: {
...
//       console.log("New course added:", newVideo);
//       clearField()
